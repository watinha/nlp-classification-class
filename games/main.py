...
filename = '../datasets/slr/games/round1-todos.bib'
...
classifier6.fit(X_np, y_np)
print('Gaussian Naive Bayes')
print(classifier6.score(X_np, y_np))
print(accuracy_score(y_np, classifier6.predict(X_np)))
